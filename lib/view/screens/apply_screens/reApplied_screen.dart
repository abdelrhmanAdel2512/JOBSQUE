...
class ReAppliedScreen extends StatelessWidget {
  const ReAppliedScreen({super.key});
              ...
              child: Column(
                children: [
                  ClipRRect(
                      ...
                      child: Image.network(
                        selectedJobController.selectedData.image!,
                        width: 0.2 * width,
                      )),
                  SizedBox(
                    height: 0.03 * height,
                  ...
                  Text(
                    selectedJobController.selectedData.name!,
                    style: const TextStyle(fontWeight: FontWeight.w500, fontSize: 24),
                  ),
                  Text(
                      '${selectedJobController.selectedData.compName!} •${selectedJobController.selectedData.location?.split(',')[selectedJobController.selectedData.location!.split(',').length - 2]} , ${selectedJobController.selectedData.location?.split(',').last}'),
                  SizedBox(
                    height: 0.03 * height,
                  ),
