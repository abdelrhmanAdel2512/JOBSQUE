...
class UploadPortfolio2 extends StatelessWidget {
  UploadPortfolio2({super.key});

  final CompleteProfileController completeProfileController = Get.put<CompleteProfileController>(CompleteProfileController());
